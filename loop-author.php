<div class="blog-wrapper main-blog">
	<div class="row">
				<div class="small-12 columns author-box">
					<?php
						$curauth = (isset($_GET['author_name'])) ? get_user_by('slug', $author_name) : get_userdata(intval($author));
					?>
					<h3 class="author-title"><?php echo $curauth->display_name; ?></h3>
					<p><small><?php echo $curauth->description; ?></small></p>
				</div>
			</div>
	<div class="row">
					...
					<div class="row">
						...
						<div class="small-12 medium-10 columns">
							...
							<div class="hide-for-medium">
								<p class="uppercase"><small><i class="fa fa-calendar" aria-hidden="true"></i> <?php the_time('d M'); ?></small> <small class="float-right"><?php the_category( ', ' ); ?></small></p>
							</div><!-- columns -->
							<p><?php the_excerpt(); ?></p>
							<?php if (has_tag( )): ?>

...
function bfp_enqueue_css() {
	...
	wp_enqueue_style( 'custom-google-fonts', 'https://fonts.googleapis.com/css?family=Armata%7COpen+Sans:300,400,600,700', true );
	...
	wp_enqueue_style( 'principal', get_stylesheet_directory_uri() . '/assets/css/app.css' );
...
function bfp_add_scripts() {
	...
	wp_enqueue_script('owlslide', get_template_directory_uri() . '/assets/js/owl.carousel.min.js', array(), 'null', true);
	wp_enqueue_script('stellar', get_template_directory_uri() . '/assets/js/jquery.stellar.js', array(), 'null', true);
	wp_enqueue_script('bfpscript', get_template_directory_uri() . '/assets/js/app.js', array(), 'null', true);

}
add_action('wp_enqueue_scripts','bfp_add_scripts', 99);
